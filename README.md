...
I'm a **frontend developer and consultant** who transforms ideas into pixel-perfect, high-performance web applications. From **Figma mockups** to **production deployment**, I handle the complete development lifecycle with expertise in modern JavaScript frameworks and cloud infrastructure.
...
🎨 **Design to Code** - Transform Figma designs into responsive, accessible web applications  
⚡ **Modern Frameworks** - Build scalable solutions with React, Vue, and Angular  
🚢 **Full Deployment** - Manage VPS, CI/CD pipelines, and production infrastructure  
🔧 **Consulting** - Optimize existing codebases and mentor development teams
